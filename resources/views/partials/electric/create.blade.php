...
@section('content')
    <div class="max-w-md mx-auto p-4 bg-white rounded-lg shadow mt-6">
        <form action="{{ route('electric.store') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div>
                <label for="reading" class="block text-sm font-medium text-gray-700 mb-1">Enter electric reading for today:</label>
